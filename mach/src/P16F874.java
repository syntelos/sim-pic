...
/**
 * Generated SimPic Port of P16F874.
 */
public class P16F874
    extends lib.mach.AbstractMachine
{
    ...
    public final Bit EEIE = new Bit(this,this.TRISE,"EEIE",0x4);
    ...
    public final Bit PCFG3 = new Bit(this,this.TXSTA,"PCFG3",0x3);
    public final Bit PCFG2 = new Bit(this,this.TXSTA,"PCFG2",0x2);
    public final Bit PCFG1 = new Bit(this,this.TXSTA,"PCFG1",0x1);
    public final Bit PCFG0 = new Bit(this,this.TXSTA,"PCFG0",0x0);
    public final Bit EEPGD = new Bit(this,this.TXSTA,"EEPGD",0x7);
    public final Bit WRERR = new Bit(this,this.TXSTA,"WRERR",0x3);
    public final Bit WREN = new Bit(this,this.TXSTA,"WREN",0x2);
    public final Bit WR = new Bit(this,this.TXSTA,"WR",0x1);
    public final Bit RD = new Bit(this,this.TXSTA,"RD",0x0);
    public final Bit _CP_ALL = new Bit(this,this.TXSTA,"_CP_ALL",0xfcf);
    public final Bit _CP_HALF = new Bit(this,this.TXSTA,"_CP_HALF",0x1fdf);
    public final Bit _CP_UPPER_256 = new Bit(this,this.TXSTA,"_CP_UPPER_256",0x2fef);
    public final Bit _CP_OFF = new Bit(this,this.TXSTA,"_CP_OFF",0x3fff);
    public final Bit _DEBUG_ON = new Bit(this,this.TXSTA,"_DEBUG_ON",0x37ff);
    public final Bit _DEBUG_OFF = new Bit(this,this.TXSTA,"_DEBUG_OFF",0x3fff);
    public final Bit _WRT_ENABLE_ON = new Bit(this,this.TXSTA,"_WRT_ENABLE_ON",0x3fff);
    public final Bit _WRT_ENABLE_OFF = new Bit(this,this.TXSTA,"_WRT_ENABLE_OFF",0x3dff);
    public final Bit _CPD_ON = new Bit(this,this.TXSTA,"_CPD_ON",0x3eff);
    public final Bit _CPD_OFF = new Bit(this,this.TXSTA,"_CPD_OFF",0x3fff);
    public final Bit _LVP_ON = new Bit(this,this.TXSTA,"_LVP_ON",0x3fff);
    public final Bit _LVP_OFF = new Bit(this,this.TXSTA,"_LVP_OFF",0x3f7f);
    public final Bit _BODEN_ON = new Bit(this,this.TXSTA,"_BODEN_ON",0x3fff);
    public final Bit _BODEN_OFF = new Bit(this,this.TXSTA,"_BODEN_OFF",0x3fbf);
    public final Bit _PWRTE_OFF = new Bit(this,this.TXSTA,"_PWRTE_OFF",0x3fff);
    public final Bit _PWRTE_ON = new Bit(this,this.TXSTA,"_PWRTE_ON",0x3ff7);
    public final Bit _WDT_ON = new Bit(this,this.TXSTA,"_WDT_ON",0x3fff);
    public final Bit _WDT_OFF = new Bit(this,this.TXSTA,"_WDT_OFF",0x3ffb);
    public final Bit _LP_OSC = new Bit(this,this.TXSTA,"_LP_OSC",0x3ffc);
    public final Bit _XT_OSC = new Bit(this,this.TXSTA,"_XT_OSC",0x3ffd);
    public final Bit _HS_OSC = new Bit(this,this.TXSTA,"_HS_OSC",0x3ffe);
    public final Bit _RC_OSC = new Bit(this,this.TXSTA,"_RC_OSC",0x3fff);
	...
	this.initBit(this._CP_HALF);
	this.initBit(this._CP_UPPER_256);
