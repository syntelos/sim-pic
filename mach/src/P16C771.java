...
/**
 * Generated SimPic Port of P16C771.
 */
public class P16C771
    extends lib.mach.AbstractMachine
{
	...
	this.initRegister(this.PMDATL);
	this.initRegister(this.PMADRL);
	...
	this.initBit(this.PWM1M1);
	this.initBit(this.PWM1M0);
	...
	this.initBit(this._ER_OSC_CLKOUT);
	this.initBit(this._ER_OSC_NOCLKOUT);
	this.initBit(this._INTRC_OSC_CLKOUT);
	this.initBit(this._INTRC_OSC_NOCLKOUT);
	this.initBit(this._EXTCLK_OSC);
