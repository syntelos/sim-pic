...
/**
 * Generated SimPic Port of P16F872.
 */
public class P16F872
    extends lib.mach.AbstractMachine
{
    ...
    public final Bit _CP_ALL = new Bit(this,this.SSPSTAT,"_CP_ALL",0xfcf);
    public final Bit _CP_HALF = new Bit(this,this.SSPSTAT,"_CP_HALF",0x1fdf);
    public final Bit _CP_UPPER_256 = new Bit(this,this.SSPSTAT,"_CP_UPPER_256",0x2fef);
    ...
    public final Bit _WRT_ENABLE_ON = new Bit(this,this.SSPSTAT,"_WRT_ENABLE_ON",0x3fff);
    public final Bit _WRT_ENABLE_OFF = new Bit(this,this.SSPSTAT,"_WRT_ENABLE_OFF",0x3dff);
    ...
    public final Bit _LP_OSC = new Bit(this,this.SSPSTAT,"_LP_OSC",0x3ffc);
    public final Bit _XT_OSC = new Bit(this,this.SSPSTAT,"_XT_OSC",0x3ffd);
    public final Bit _HS_OSC = new Bit(this,this.SSPSTAT,"_HS_OSC",0x3ffe);
    public final Bit _RC_OSC = new Bit(this,this.SSPSTAT,"_RC_OSC",0x3fff);
