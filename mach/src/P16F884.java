    ...
    extends lib.mach.AbstractMachine
{
	...
	this.initRegister(this.SSPMSK);
	this.initRegister(this.MSK);
	...
	this.initRegister(this.SPBRGH);
	this.initRegister(this.PWM1CON);
	this.initRegister(this.ECCPAS);
	this.initRegister(this.PSTRCON);
	this.initRegister(this.ADRESL);
	this.initRegister(this.ADCON1);
	this.initRegister(this.WDTCON);
	this.initRegister(this.CM1CON0);
	this.initRegister(this.CM2CON0);
	this.initRegister(this.CM2CON1);
	this.initRegister(this.EEDATA);
	this.initRegister(this.EEDAT);
	this.initRegister(this.EEADR);
	this.initRegister(this.EEDATH);
	this.initRegister(this.EEADRH);
	this.initRegister(this.SRCON);
	this.initRegister(this.BAUDCTL);
	this.initRegister(this.ANSEL);
	this.initRegister(this.ANSELH);
	...
	this.initBit(this.ULPWUIF);
	this.initBit(this.CCP2IF);
	this.initBit(this.T1GIV);
	this.initBit(this.TMR1GE);
	...
	this.initBit(this.P1M1);
	this.initBit(this.P1M0);
	this.initBit(this.DC1B1);
	this.initBit(this.CCP1X);
	this.initBit(this.DC1B0);
	...
	this.initBit(this.DC2B1);
	this.initBit(this.CCP2Y);
	this.initBit(this.DC2B0);
	...
	this.initBit(this.ULPWUIE);
	this.initBit(this.CCP2IE);
	this.initBit(this.ULPWUE);
	...
	this.initBit(this.IOCB3);
	this.initBit(this.IOCB2);
	this.initBit(this.IOCB1);
	this.initBit(this.IOCB0);
	this.initBit(this.VREN);
	this.initBit(this.VROE);
	this.initBit(this.VRR);
	this.initBit(this.VRSS);
	...
	this.initBit(this.SENDB);
	this.initBit(this.BRGH);
	this.initBit(this.TRMT);
	this.initBit(this.TX9D);
	this.initBit(this.TXD8);
	this.initBit(this.BRG7);
	this.initBit(this.BRG6);
	this.initBit(this.BRG5);
	this.initBit(this.BRG4);
	this.initBit(this.BRG3);
	this.initBit(this.BRG2);
	this.initBit(this.BRG1);
	this.initBit(this.BRG0);
	this.initBit(this.BRG15);
	this.initBit(this.BRG14);
	this.initBit(this.BRG13);
	this.initBit(this.BRG12);
	this.initBit(this.BRG11);
	this.initBit(this.BRG10);
	this.initBit(this.BRG9);
	this.initBit(this.BRG8);
	this.initBit(this.PRSEN);
	this.initBit(this.PDC6);
	this.initBit(this.PDC5);
	this.initBit(this.PDC4);
	this.initBit(this.PDC3);
	this.initBit(this.PDC2);
	this.initBit(this.PDC1);
	this.initBit(this.PDC0);
	this.initBit(this.ECCPASE);
	this.initBit(this.ECCPAS2);
	this.initBit(this.ECCPAS1);
	this.initBit(this.ECCPAS0);
	this.initBit(this.PSSAC1);
	this.initBit(this.PSSAC0);
	this.initBit(this.PSSBD1);
	this.initBit(this.PSSBD0);
	this.initBit(this.STRSYNC);
	this.initBit(this.STRD);
	this.initBit(this.STRC);
	this.initBit(this.STRB);
	this.initBit(this.STRA);
	...
	this.initBit(this.C1ON);
	this.initBit(this.C1OUT);
	this.initBit(this.C1OE);
	this.initBit(this.C1POL);
	this.initBit(this.C1R);
	this.initBit(this.C1CH1);
	this.initBit(this.C1CH0);
	this.initBit(this.C2ON);
	this.initBit(this.C2OUT);
	this.initBit(this.C2OE);
	this.initBit(this.C2POL);
	this.initBit(this.C2R);
	this.initBit(this.C2CH1);
	this.initBit(this.C2CH0);
	this.initBit(this.MC1OUT);
	this.initBit(this.MC2OUT);
	this.initBit(this.C1RSEL);
	this.initBit(this.C2RSEL);
	this.initBit(this.T1GSS);
	this.initBit(this.C2SYNC);
	this.initBit(this.SR1);
	this.initBit(this.SR0);
	this.initBit(this.C1SEN);
	this.initBit(this.C2REN);
	this.initBit(this.PULSS);
	this.initBit(this.PULSR);
	this.initBit(this.FVREN);
	this.initBit(this.ABDOVF);
	this.initBit(this.RCIDL);
	this.initBit(this.SCKP);
	this.initBit(this.BRG16);
	this.initBit(this.WUE);
	this.initBit(this.ABDEN);
	...
	this.initBit(this.ANS13);
	this.initBit(this.ANS12);
	this.initBit(this.ANS11);
	this.initBit(this.ANS10);
	this.initBit(this.ANS9);
	this.initBit(this.ANS8);
